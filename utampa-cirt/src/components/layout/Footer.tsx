      ...
      <div className="ut-container">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-300 mb-4">
              ...
              provides a comprehensive repository of criminology research and publications.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-sm text-gray-400">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p>&copy; {new Date().getFullYear()} University of Tampa. All rights reserved.</p>
            <div className="flex space-x-4 mt-4 md:mt-0">
              ...
              <Link href="https://www.ut.edu" className="hover:text-white" target="_blank" rel="noopener noreferrer">
                UT Main Site
              </Link>
            </div>
          </div>
